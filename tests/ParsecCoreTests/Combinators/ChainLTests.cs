...
namespace ParsecCoreTests
{
    public class ChainLTests
    {
        ...
        public void TwoPlusTwo()
        {
            ...
            var parser = Parsers.ChainL(Parsers.DecimalInteger, additionParser, 0);
        ...
        public void MixedOperators()
        {
            ...
            var parser = Parsers.ChainL(Parsers.DecimalInteger, Parsers.Choice(additionParser, multiplicationParser), 0);
